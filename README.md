...
- **Render-link:** [ 'https://flower-delivery-site-2.onrender.com']
...
```env
REACT_APP_API_URL=https://flower-delivery-site-2.onrender.com
 Getting Started
bash
Copy
Edit
...
env
MONGO_URI=mongodb+srv://MaryamSaye:udylBy2oBAYBozud@cluster0.twjnb.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0
PORT=4002
 Getting Started
bash
Copy
...
Copy
Edit
https://flower-delivery-site-2.onrender.com/uploads/<filename>
Example:

bash
Copy
Edit
https://flower-delivery-site-2.onrender.com/uploads/flower1_1715601234567.jpg
...
GitHub: https://github.com/maryamsaye/flower-delivery-site-2.git

## License
This project is licensed under the MIT License. See the LICENSE file for details.# flower-delivery-site-2